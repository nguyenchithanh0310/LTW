                        ...
                        <div class="login-form">
                            <div class="row">
                                <div class="col-md-12 col-12 mb--20">
                                    ...
                                    <input class="mb-0" type="email" name="user">
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="d-flex align-items-center flex-wrap">
                                        <button class="btn btn-black me-3" type="submit">Dang Nhap</button>
                                    ...
                                    <p><a href="forgotpassword.html" class="pass-lost mt-3">Quên mật khẩu?</a></p>
                                </div>
                            </div>
                        </div>
                    </form>
